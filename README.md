Hibernate search example: How to Use Hibernate 4, Hibernate search in jboss as 7
====================================================
Author: Keven Wang based on jboss-as-quickstart hibernate 4 example
...
This quickstart is based upon the kitchensink example, but demonstrates how to use Hibernate ORM 4 over JPA with hibernate search in JBoss Enterprise Application Platform 6 or JBoss AS 7.
...
The application will be running at the following URL: <http://localhost:8080/hibernate-search-example/>.
